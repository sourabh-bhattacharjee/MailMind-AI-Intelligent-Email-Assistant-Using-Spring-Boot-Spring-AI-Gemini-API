...
User opens Gmail
Chrome extension injects AI assistant UI
User clicks “Generate Reply”
Email content is sent to Spring Boot backend
Backend processes prompts using Spring AI
Gemini API generates intelligent response
AI-generated reply appears instantly in Gmail
📡 API Endpoints
